...
const SpecialResearchGrantPartII: FC<any> = props => {
    const { Option } = Select;
    ...
    return (
        <Fragment>
            <div className="form-page-content form-page-content-registration">
				<div className="form-main-title"><span>PART – II: INFORMATION ABOUT PROJECT PERSONNEL</span></div>
                <Form
                    {...formItemLayout}
                    form={formRef}
		...
		<div className="project-personal-detail">	 
                ...
                <div className="form-colored-text"> A. Principal Investigator (PI) </div>				
				<Row gutter={[16, 16]}>
						<Col xs={24} md={12}>
...
export default React.memo(SpecialResearchGrantPartII);