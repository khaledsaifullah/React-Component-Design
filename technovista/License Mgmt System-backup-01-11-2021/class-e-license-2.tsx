    ...
    return (
        <Fragment>
            ...
            <div className="form-page-content form-page-content-registration bstf-form">
                ...
                >
				<h3 className="bstf-form-title"> ৫. এই আবেদন পত্রের ব্যাপারে যোগাযোগের জন্য প্রাধিকার প্রাপ্ত ব্যাক্তির বিবরণ  </h3>
				<div className="form-childform-content">
						<Row gutter={[16, 16]}>
							...
							<Col xs={24} md={12}>
								<Form.Item label=" এনআইডি  *" name="licence_number " >
									<Input />
								</Form.Item>		
							</Col>
						</Row>	
				...
				<h3 className="bstf-form-title"> ৬. বিকিরণ নিয়ন্ত্রণ কর্মকর্তার (আর. সি. ও) বিবরণ  </h3>
				<div className="form-childform-content">
						...
						<Row gutter={[16, 16]}>
							...
							<Col xs={24} md={12}>
								<Form.Item label="পুরুষ/মহিলা  *" name="gender">
									<Select placeholder=" " >
										<Option value={"Male"}>Male </Option>
										<Option value={"Female"}>Female</Option>
									</Select>
						...
						<Row gutter={[16, 16]}>
							<Col xs={24} md={12}>
								<Form.Item label="আর. সি. ও অনুমোদন নং  " name="licence_number " >
									<Input />
								</Form.Item>		
							</Col>
							<Col xs={24} md={12}>
						...
						<Row gutter={[16, 16]}>
							<Col xs={24} md={12}>
								<Form.Item label="বৈধতার মেয়াদ  * " name="licence_number " >
									<Input />
								</Form.Item>		
							</Col>
							<Col xs={24} md={12}>
				...
				<h3 className="bstf-form-title"> ৭. "ঘ" শ্ৰেণীর লাইসেন্স সংক্রান্ত তথ্য  (প্রযোজ্য ক্ষেত্রে )  </h3>
				<div className="form-childform-content">
					<Row gutter={[16, 16]}>
						<Col xs={24} md={12}>
							<div className="form-padding-10"> লাইসেন্স নং   </div>
							<div className="form-padding-10">
								<Form.Item   name="licence_number " >
									<Input />
								</Form.Item>	
