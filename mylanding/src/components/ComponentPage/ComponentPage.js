...
import headerbannertwo from './images/header-two.jpg';
    ...
    render() {
        return (
			<div className="pageone-content">
				 <div  className="header-banner"><img src={headerbannertwo} alt="headerbanner" /></div>
				 
				 <div  className="grant-fellowship-content">
				    <div className="grantfellowship-icon"><img src={grantfellowicon} alt="grantfellowicon" /></div>
					<h3>Grants/Fellowship</h3>
